...
function StudentPluginCard() {
    ...
    const fetchPlugins = async () => {
        try {
            const response = await axios.get(`/releases/student?page=${page}`);
            ...
            <div className="plugin-header">
                <div className="button-container " style={{display: 'flex', gap: '15px', alignItems: 'center'}}>
                    ...
                    <button
                        ...
                        onClick={() => {
                            navigator.clipboard.writeText('https://rafplugins.store/studentplugin/update');
                            alert('Link kopiran!');
                        }}
                    >
                    ...
                    <a
                        ...
                        href="https://github.com/RAFSoftLab/RAF-LMS"
                        target="_blank"
